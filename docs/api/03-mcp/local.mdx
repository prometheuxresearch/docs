...
:::info Looking for Claude Web, Genie Code, or Other Clients?
If you want to connect from Claude Web, Genie Code, or any other MCP client, check out the [Remote MCP Server](/api/mcp/remote) and the [Client Guides](/api/mcp/clients).
:::
...
- **Remote MCP Server:** See [Remote MCP Server](/api/mcp/remote) for Claude Web integration
