...
:::info Looking for Claude Web Integration?
If you want to use Prometheux with Claude Web (browser-based), check out the [Remote MCP Server](/api/mcp/remote) documentation instead.
:::
