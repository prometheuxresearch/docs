...
The Prometheux platform provides two ways to interact with all platform features programmatically:
...
Both interfaces provide equivalent functionality—choose the one that best fits your workflow.
