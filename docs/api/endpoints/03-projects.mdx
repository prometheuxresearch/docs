...
templates = px.list_templates(workspace_id="workspace_id")
...
# List projects
curl -X GET "https://api.prometheux.ai/jarvispy/my-org/my-user/api/v1/projects/workspace_id/list?scopes=user" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"

# Load a specific project
curl -X GET "https://api.prometheux.ai/jarvispy/my-org/my-user/api/v1/projects/workspace_id/load?project_id=proj_12345" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
