...
| Client | Guide |
|--------|-------|
| **Claude** (Desktop & Web) | [Connect Claude →](/api/mcp/clients/claude) |
| **Genie Code** (Databricks) | [Connect Genie Code →](/api/mcp/clients/databricks-genie) |
...
- **Available Tools:** See [MCP Overview](/api/mcp#available-tools) for the full tool reference
