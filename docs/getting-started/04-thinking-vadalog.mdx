...
[aggregators](/learn/vadalog/expressions/aggregations),
...
aggregation](/learn/vadalog/expressions/aggregations) to the joint shares for any given intermediary to
...
variable `_`](/learn/vadalog/language-primitives#anonymous-variables) into the 2nd position. This argument is never processed anyway, so
